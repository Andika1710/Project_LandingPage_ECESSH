...
import logo from '../../assets/logo_ecessh.png'
import TextLogo from '../../assets/TextEch1.png'
...
const Header = () => {
  ...
  return (
    <>
 <div className='header w-full bg-globalBlue h-[45px] lg:h-[90px]'>
            ...
            <div className='flex gap-[10px] lg:gap-[16px] px-[5px] lg:justify-center  lg:items-center '>
                      <img className='h-[32px] lg:h-[60px]  ' src={logo} alt="logoEcesi" />
                  <div className='py-[3px] '>
                      <img className='h-[12px] lg:h-[20px]  ' src={TextLogo} alt="TextECESh" />
            ...
            <button className=' bg-white hover:bg-globalBlue  mr-[10px] mt-2  pt-[18px] pb-2  rounded-t-lg px-[46px]'>
            <ul className='flex flex-col gap-[10px] lg:hidden justify-between text-globalBlue  text-[18px] leading-[18.9px] font-semibold'>
            ...
            <button className=' bg-white hover:bg-globalBlue  mr-[10px]  py-[10px]  px-[30px]'>
            <ul className='flex flex-col gap-[10px] lg:hidden justify-between text-globalBlue  text-[18px] leading-[18.9px] font-semibold'>
            ...
            <button className=' bg-white hover:bg-globalBlue  mr-[10px]  py-[10px] px-[36px] '>
            <ul className='flex flex-col gap-[10px] lg:hidden justify-between text-globalBlue  text-[18px] leading-[18.9px] font-semibold'>
            ...
            <button className=' bg-white hover:bg-globalBlue  mr-[10px] py-[10px]  px-[52px] '>
            <ul className='flex flex-col gap-[10px] lg:hidden justify-between text-globalBlue  text-[18px] leading-[18.9px] font-semibold'>
            ...
            <button className=' bg-white hover:bg-globalBlue  mr-[10px]  py-[10px] px-[65px]'>
            <ul className='flex flex-col gap-[10px] lg:hidden justify-between text-globalBlue  text-[18px] leading-[18.9px] font-semibold'>
            ...
            <button className=' bg-white hover:bg-globalBlue  mr-[10px] py-[10px] px-[76px] rounded-b-lg'>
            <ul className='flex flex-col gap-[10px] lg:hidden justify-between text-globalBlue  text-[18px] leading-[18.9px] font-semibold'>
