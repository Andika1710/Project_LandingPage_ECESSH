...
import logoFooter from '../../assets/LogoEsh.png'
...
const Footer = () => {
  return (
    <>
    <footer className='w-full bg-globalBlue mt-20 lg:mt-0'>
        <div className='container lg:flex lg:justify-between mx-auto px-[35px] pt-[40px] pb-[112px]'>
            <figure className='flex justify-center items-center'>
                ...
                <figcaption className='text-start lg:text-left lg:mr-[30px] '>
                      ...
                      <p className='text-[15px] lg:text-[36px] lg:leading-[33.2px] text-white font-bold font-jakarta'>ECONOMICS</p>
                      <div className='lg:py-[-60px] mt-1 '>
                      <p className='text-[10px] lg:text-[15px] bg-white   font-bold font-jakarta opacity-100 rounded-[5px] px-[10px]  flex justify-center items-center  text-blue-600'>2024</p>
                      </div>
                      </div>
                      <p className='text-[15px] lg:text-[36px] lg:leading-[33.2px] text-white font-bold font-jakarta'>SOCIAL SCIENCES</p>
                      <p className='text-[15px] lg:text-[36px] lg:leading-[33.2px] text-white font-bold font-jakarta'>AND HUMANITIES</p>
            ...
            <div className='flex flex-col mt-[32px] text-white lg:w-[232px] px-[35px]'>
                ...
                <Link to='/about'>
                    <p className='mt-[20px] text-[12px] leading-[14.4px] lg:text-[14px] lg:leading-[16.8px] font-semibold font-jakarta lg:w-[232px]'>The Eastasouth Conference on Economics, Social Sciences, and Humanities (ECESSH) is an annual international conference organized by the Eastasouth Insti.</p>
                </Link>
            </div>
